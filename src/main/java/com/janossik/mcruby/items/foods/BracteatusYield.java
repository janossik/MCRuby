...
public class BracteatusYield extends Item {
    public BracteatusYield(){
        super(new Item.Properties().group(McRubyMod.TAB_MOD).food(new Food.Builder()
                .hunger(5)
                .saturation(1.5f)
                .effect(() -> new EffectInstance(Effects.REGENERATION, Config.RUBY_REGENERATION_DURATION.get(), 1), 0.3f)
                .build()));
    }
    ...
    public void addInformation(ItemStack stack, World world, List<ITextComponent> tooltip, ITooltipFlag flag)
    {
        ...
        {
            tooltip.add(new TranslationTextComponent("mcruby.item.tooltip.bracteatusyield"));
        }
        else
        {
